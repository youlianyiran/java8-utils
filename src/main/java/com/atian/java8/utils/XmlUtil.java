...
/**
 * Created by xutiantian on 2017/2/23.
 */
public class XmlUtil {
    public static Element readxml(String filePath) {
        ...
        try {
            ...
            throw new RuntimeException("<<XmlUtil>> cannnot parse xml file : " + filePath, e);
    ...
    public static Element readxml(File xmlFile) {
        ...
        try {
            ...
            throw new RuntimeException("<<XmlUtil>> cannnot parse xml file : " + xmlFile.getAbsolutePath(), e);
    ...
    public static String getAttributeAsString(Element element, String attrName) {
        PreconditionUtil.checkArgument(element.hasAttribute(attrName), String.format("There is no attribute(%s) in element(%s)!", attrName, element.getNodeName()));
